...
) ENGINE=InnoDB AUTO_INCREMENT=1994043228520824840 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wms_inventory_detail` (
  ...
  `update_time` datetime(3) DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1994076021048520707 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci ROW_FORMAT=DYNAMIC COMMENT='库存详情';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wms_inventory_history` (
  ...
  `create_time` datetime(3) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1994076021765746691 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='库存记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wms_receipt_order` (
  ...
  `update_time` datetime(3) DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1994076020444540930 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='入库单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wms_receipt_order` VALUES (1992787885475516417,'RK11248425',2,1828354153193836545,'001',400.00,36000.00,1,1992782506943336450,1992782571778887681,NULL,'admin','2025-11-24 10:50:30.764','admin','2025-11-24 10:58:31.345'),(1994076020444540929,'RK11281402',2,NULL,NULL,1.00,100.00,1,1992782506943336450,1992782571778887681,NULL,'admin','2025-11-28 00:09:06.075','admin','2025-11-28 00:09:06.075');
...
CREATE TABLE `wms_receipt_order_detail` (
  ...
  `area_id` bigint DEFAULT NULL COMMENT '所属库区',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1994076020855582723 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='入库单详情';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wms_serial_number` (
  `sn_id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  ...
  `bind_status` char(1) DEFAULT '0' COMMENT '绑定状态 0-未绑定 1-已绑定',
  `inbound_time` datetime DEFAULT NULL COMMENT '入库时间',
  `receipt_order_no` varchar(50) DEFAULT NULL COMMENT '入库单号',
  `shipment_order_no` varchar(50) DEFAULT NULL COMMENT '出库单号',
  `warehouse_id` bigint DEFAULT NULL COMMENT '当前位置（仓库ID）',
  `rack_no` varchar(50) DEFAULT NULL COMMENT '当前位置（货架编号）',
  ...
  KEY `idx_receipt_order_no` (`receipt_order_no`),
  KEY `idx_shipment_order_no` (`shipment_order_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='序列号/SN码表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `wms_serial_number`
--

LOCK TABLES `wms_serial_number` WRITE;
/*!40000 ALTER TABLE `wms_serial_number` DISABLE KEYS */;
/*!40000 ALTER TABLE `wms_serial_number` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-11-28  0:13:53
